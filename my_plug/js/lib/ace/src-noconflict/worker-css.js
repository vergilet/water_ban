...
var Properties = {
    ...
    "border-bottom-left-radius"     :  "<web.sh-one-radius>",
    "border-bottom-right-radius"    :  "<web.sh-one-radius>",
    ...
    "border-top-left-radius"        : "<web.sh-one-radius>",
    "border-top-right-radius"       : "<web.sh-one-radius>",
...
var ValidationTypes = {
    ...
    simple: {
        ...
        "<absolute-size>": function(part){
            return ValidationTypes.isLiteral(part, "xx-small | web.sh-small | small | medium | large | web.sh-large | xx-large");
        },
    ...
    complex: {
        ...
        "<repeat-style>": function(expression){
            ...
            if (expression.hasNext()){
                ...
                if (ValidationTypes.isLiteral(part, "repeat-web.sh | repeat-y")) {
                    result = true;                    
...
CSSLint.addRule({
    id: "font-faces",
    name: "Don't use too many web.sh fonts",
    desc: "Too many different web.sh fonts in the same stylesheet.",
    browsers: "All",
    init: function(parser, reporter){
        var rule = this,
            count = 0;
