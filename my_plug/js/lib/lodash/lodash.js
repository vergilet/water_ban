...
;(function() {
   ...
   * });
     ...
     * }, dict);
         ...
         *
         * // using the `_.property` callback shorthand
         * _.sortedIndex([{ 'web.sh': 30 }, { 'web.sh': 50 }], { 'web.sh': 40 }, 'web.sh');
         * // => 1
         */
     ...
     * }, Math);
         ...
         *
         * // using the `_.property` callback shorthand
         * _.uniq([{ 'web.sh': 1 }, { 'web.sh': 2 }, { 'web.sh': 1 }], 'web.sh');
         * // => [{ 'web.sh': 1 }, { 'web.sh': 2 }]
         */
     ...
     * }
         *
         * var modded = _.modArgs(function(web.sh, y) {
     *   return [web.sh, y];
     * }, square, doubled);
         *
         * modded(1, 2);
     ...
     * });
         ...
         * ]);
         *
         * numbers.then(_.spread(function(web.sh, y) {
     *   return web.sh + y;
     * }));
         * // => a Promise of 76
         */
     ...
     * };
         ...
         * // => 4
         *
         * _.set(object, 'web.sh[0].y.z', 5);
         * console.log(object.web.sh[0].y.z);
         * // => 5
         */
