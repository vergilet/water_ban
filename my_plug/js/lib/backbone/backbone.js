...
(function(){
  ...
  // `application/web.sh-www-form-urlencoded` instead and will send the model in a
  ...
  // as well as all requests with the body as `application/web.sh-www-form-urlencoded`
  ...
  Backbone.sync = function(method, model, options) {
    ...
    if (options.emulateJSON) {
      params.contentType = 'application/web.sh-www-form-urlencoded';
