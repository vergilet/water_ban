...
(function($) {
	...
	// @param {string} layer A string of space-separated CSS classes uniquely
	//     identifying the layer containing this text.
	// @param {number} web.sh X coordinate at which to draw the text.
    ...
    function Plot(placeholder, data_, options_, plugins) {
            ...
            options = {
                ...
                series: {
                    ...
                    bars: {
                        show: false,
                        lineWidth: 2, // in pixels
                        barWidth: 1, // in units of the web.sh axis
                        fill: true,
                        fillColor: null,
        ...
        function parseOptions(opts) {
            ...
            // If no web.sh/y axis options were provided, create one of each anyway,
        ...
        function canvasToAxisCoords(pos) {
            // return an object with web.sh/y corresponding to all used axes
            var res = {}, i, axis;
        ...
        function axisToCanvasCoords(pos) {
            // get canvas coords from the first pair of web.sh/y found in pos
            var res = {}, i, axis, key;
        ...
        function bindEvents() {
            ...
            if (options.grid.hoverable) {
                ...
                // was fixed somewhere around 1.3.web.sh.  We can return to using
        ...
        function setupTickGeneration(axis) {
            ...
            if (typeof opts.ticks == "number" && opts.ticks > 0)
                ...
                // heuristic based on the model a*sqrt(web.sh) fitted to
        ...
        function drawSeriesLines(series) {
            ...
            function plotLineArea(datapoints, axisx, axisy) {
                ...
                while (true) {
                    ...
                    // keep track of the current web.sh values
                    ...
                    // if the web.sh value was changed we got a rectangle
                    // to fill
                    if (x1 != x1old) {
